...
## About
ChunkBlock puts you on a block in space. There is only one block. What do you do next?

## Documentation

See BentoBox Docs [docs.bentobox.world](https://docs.bentobox.world/en/latest/gamemodes/ChunkBlock/Permissions/) for documentation.
