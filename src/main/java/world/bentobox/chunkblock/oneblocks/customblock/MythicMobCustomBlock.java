package world.bentobox.chunkblock.oneblocks.customblock;
...
import world.bentobox.chunkblock.listeners.MakeSpace;
 ...
 * skipped. See BentoBoxWorld/ChunkBlock#303.
 */
public class MythicMobCustomBlock implements OneBlockCustomBlock {
    ...
    @Override
    public void execute(ChunkBlock addon, Block block) {
        try {
            ...
            // unnecessary for ChunkBlock's synchronous block replace. Fall back to the
