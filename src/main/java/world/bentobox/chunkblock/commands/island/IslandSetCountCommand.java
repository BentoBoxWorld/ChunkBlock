...
public class IslandSetCountCommand extends CompositeCommand {
    ...
    public void setup() {
        setOnlyPlayer(true);
        setParametersHelp("chunkblock.commands.island.setcount.parameters");
        setDescription("chunkblock.commands.island.setcount.description");
        // Permission
    ...
    public boolean execute(User user, String label, List<String> args) {
        ...
        if (count > maxCount) {
            user.sendMessage("chunkblock.commands.island.setcount.too-high", TextVariables.NUMBER, String.valueOf(maxCount));
            return false;
        }
        i.setBlockNumber(count);
        i.clearQueue();
        user.sendMessage("chunkblock.commands.island.setcount.set", TextVariables.NUMBER, String.valueOf(i.getBlockNumber()));
