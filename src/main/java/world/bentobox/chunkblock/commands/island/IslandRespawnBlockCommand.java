...
public class IslandRespawnBlockCommand extends CompositeCommand
{
    ...
    public void setup()
    {
        this.setDescription("chunkblock.commands.respawn-block.description");
    ...
    public boolean execute(User user, String label, List<String> args)
    {
                ...
                island.getCenter().getBlock().getType() == Material.AIR)
        {
            ...
            user.sendMessage("chunkblock.commands.respawn-block.block-respawned");
        }
        else
        {
            ...
            user.sendMessage("chunkblock.commands.respawn-block.block-exist");
        }
