...
public class Settings implements WorldSettings {
    ...
    @ConfigEntry(path = "chunkblock.command.new-player-action") // , since = "1.2.0")
    ...
    @ConfigEntry(path = "chunkblock.command.default-action") // , since = "1.2.0")
    ...
    @ConfigEntry(path = "chunkblock.command.count-command") // , since = "1.10.0")
    ...
    @ConfigEntry(path = "chunkblock.command.phases-command") // , since = "1.10.0")
    ...
    @ConfigEntry(path = "chunkblock.command.set-count-command") // , since = "1.10.0")
    private String setCountCommand = "setCount";

    @ConfigComment("Enables the bossbar and its command to show progress.")
    @ConfigEntry(path = "chunkblock.command.bossbar", since = "1.21.2")
    ...
    @ConfigEntry(path = "chunkblock.command.bossbar-command") // , since = "1.19.0")
    private String bossBarCommand = "bossbar";
    
    @ConfigComment("Enables the action bar and its command to show progress.")
    @ConfigEntry(path = "chunkblock.command.actionbar", since = "1.21.2")
    ...
    @ConfigEntry(path = "chunkblock.command.actionbar-command", since = "1.21.2")
    ...
    @ConfigEntry(path = "chunkblock.command.set-count-cooldown") // , since = "1.13.0")
    ...
    @ConfigEntry(path = "chunkblock.command.respawn-block-command") // , since = "1.10.0")
    ...
    private String friendlyName = "ChunkBlock";

    @ConfigComment("Name of the world - if it does not exist then it will be generated.")
    @ConfigComment("It acts like a prefix for nether and end (e.g. chunkblock_world, chunkblock_world_nether, chunkblock_world_end)")
    @ConfigEntry(path = "world.world-name")
    private String worldName = "chunkblock_world";
    ...
    @ConfigComment("Players can have the chunkblock.coop.maxsize.<number> permission to be bigger but")
    @ConfigComment("permission size cannot be less than the default below. ")
    ...
    @ConfigComment("Players can have the chunkblock.trust.maxsize.<number> permission to be bigger but")
    @ConfigComment("permission size cannot be less than the default below. ")
    ...
    @ConfigComment("ChunkBlock blocked mobs.")
    @ConfigComment("List of mobs that should not spawn in ChunkBlock.")
     ...
     */
    @Nullable
    public Particle resolveChestParticle(world.bentobox.chunkblock.oneblocks.OneBlockObject.Rarity rarity) {
     ...
     */
    public Color resolveChestColor(world.bentobox.chunkblock.oneblocks.OneBlockObject.Rarity rarity) {
        return switch (rarity) {
