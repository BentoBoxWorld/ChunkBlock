...
public class AdminPhasesPanel {
    ...
    private static final String REF = "chunkblock.commands.admin.phases.gui.";
    ...
    AdminPhasesPanel(ChunkBlock addon, User user) {
        this.addon = addon;
        this.user = user;
    }
     ...
     */
    public static void openPanel(ChunkBlock addon, User user) {
    ...
    private void persist() {
        ...
        if (saved) {
            user.sendMessage("chunkblock.commands.admin.phases.saved");
        } else {
            user.sendMessage("chunkblock.commands.admin.phases.save-failed");
        }
        build();
    }
}
