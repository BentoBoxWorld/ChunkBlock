...
public class InfoListener implements Listener {
    ...
    final ChunkBlock addon;

    /**
     * Add info to the info command
     * @param addon - ChunkBlock
     */
    public InfoListener(ChunkBlock addon) {
        this.addon = addon;
    }
    ...
    public void onInfo(IslandInfoEvent e) {
        // Check if island is in ChunkBlock
        ...
        user.sendMessage("chunkblock.commands.info.count", TextVariables.NUMBER, String.valueOf(is.getBlockNumber()), 
