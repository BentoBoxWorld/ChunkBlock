...
import world.bentobox.chunkblock.events.MagicBlockEntityEvent;
import world.bentobox.chunkblock.events.MagicBlockEvent;
import world.bentobox.chunkblock.events.MagicBlockPhaseEvent;
...
public class BlockListener extends FlagListener implements Listener {
     ...
     */
    public BlockListener(@NonNull ChunkBlock addon) {
        this.addon = addon;
     ...
     * @see <a href="https://github.com/BentoBoxWorld/ChunkBlock/issues/534">Issue #534</a>
     */
