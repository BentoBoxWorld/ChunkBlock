 ...
 * BentoBoxWorld/ChunkBlock#303. Execute-path behavior (hook lookup, callback
...
class MythicMobCustomBlockTest {
    ...
    void registeredUnderMythicMobType() {
        ...
        var result = world.bentobox.chunkblock.oneblocks.OneBlockCustomBlockCreator.create(map);
        assertTrue(result.isPresent());
