...
class InfoListenerTest extends CommonTestSetup {
    ...
    /**
     * Test method for {@link world.bentobox.chunkblock.listeners.InfoListener#InfoListener(world.bentobox.chunkblock.ChunkBlock)}.
     */
    @Test
    ...
    /**
     * Test method for {@link world.bentobox.chunkblock.listeners.InfoListener#onInfo(world.bentobox.bentobox.api.events.island.IslandInfoEvent)}.
     */
    @Test
    void testOnInfo() {
        IslandInfoEvent e = new IslandInfoEvent(island, ID, false, location, addon);
        il.onInfo(e);
        verify(lm).get(any(User.class), eq("chunkblock.commands.info.count"));
    }
    ...
    void testOnInfoOtherAddon() {
        ...
        il.onInfo(e);
        verify(lm, never()).get(any(User.class), eq("chunkblock.commands.info.count"));
    }
