...
class JoinLeaveListenerTest extends CommonTestSetup {
    ...
    /**
     * Test method for {@link world.bentobox.chunkblock.listeners.JoinLeaveListener#JoinLeaveListener(world.bentobox.chunkblock.ChunkBlock)}.
     */
    @Test
    ...
    /**
     * Test method for {@link world.bentobox.chunkblock.listeners.JoinLeaveListener#onPlayerQuit(org.bukkit.event.player.PlayerQuitEvent)}.
     */
    @Test
    ...
    void testOnPlayerQuitSaveError() {
        ...
        verify(bl).saveIsland(island);
        verify(aob).logError("Could not save ChunkBlock island at 123,120,456 to database null");
    }
