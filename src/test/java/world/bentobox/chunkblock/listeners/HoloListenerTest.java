...
public class HoloListenerTest extends CommonTestSetup {
    ...
    /**
     * Test method for {@link world.bentobox.chunkblock.listeners.HoloListener#HoloListener(world.bentobox.chunkblock.ChunkBlock)}.
     */
    @Test
    ...
    /**
     * Test method for {@link world.bentobox.chunkblock.listeners.HoloListener#onDeletedIsland(world.bentobox.bentobox.api.events.island.IslandDeleteEvent)}.
     */
    @Test
    ...
    /**
     * Test method for {@link world.bentobox.chunkblock.listeners.HoloListener#onDisable()}.
     */
    @Test
    void testOnDisable() {
    ...
    /**
     * Test method for {@link world.bentobox.chunkblock.listeners.HoloListener#setUp(world.bentobox.bentobox.database.objects.Island, world.bentobox.chunkblock.dataobjects.OneBlockIslands, boolean)}.
     */
    @Test
    ...
    void testSetUpNewIsland() {
        hl.setUp(island, is, true);
        verify(is).setHologram("chunkblock.island.starting-hologram");
    ...
    /**
     * Test method for {@link world.bentobox.chunkblock.listeners.HoloListener#process(world.bentobox.bentobox.database.objects.Island, world.bentobox.chunkblock.dataobjects.OneBlockIslands, world.bentobox.chunkblock.oneblocks.OneBlockPhase)}.
     */
    @Test
