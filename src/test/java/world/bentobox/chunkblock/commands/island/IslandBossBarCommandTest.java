...
class IslandBossBarCommandTest extends CommonTestSetup {
    ...
    /**
     * Test method for {@link world.bentobox.chunkblock.commands.island.IslandBossBarCommand#IslandBossBarCommand(world.bentobox.bentobox.api.commands.CompositeCommand, java.lang.String, java.lang.String[])}.
     */
    @Test
    ...
    /**
     * Test method for {@link world.bentobox.chunkblock.commands.island.IslandBossBarCommand#setup()}.
     */
    @Test
    void testSetup() {
        assertEquals("island.bossbar", bbc.getPermission());
        assertEquals("chunkblock.commands.island.bossbar.description", bbc.getDescription());
        assertTrue(bbc.isOnlyPlayer());
    }

    /**
     * Test method for {@link world.bentobox.chunkblock.commands.island.IslandBossBarCommand#execute(world.bentobox.bentobox.api.user.User, java.lang.String, java.util.List)}.
     */
    @Test
    void testExecuteUserStringListOfString() {
        bbc.execute(user, "", List.of());
        verify(bb).toggleUser(user);
        verify(user).sendMessage("chunkblock.bossbar.not-active");
    }
