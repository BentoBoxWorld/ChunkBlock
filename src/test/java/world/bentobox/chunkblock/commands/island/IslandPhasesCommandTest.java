...
class IslandPhasesCommandTest extends CommonTestSetup {
    ...
    /**
     * Test method for {@link world.bentobox.chunkblock.commands.island.IslandPhasesCommand#IslandPhasesCommand(world.bentobox.bentobox.api.commands.CompositeCommand, java.lang.String, java.lang.String[])}.
     */
    @Test
    ...
    /**
     * Test method for {@link world.bentobox.chunkblock.commands.island.IslandPhasesCommand#setup()}.
     */
    @Test
    void testSetup() {
        assertEquals("phases", ipc.getPermission());
        assertEquals("chunkblock.commands.phases.description", ipc.getDescription());
        assertTrue(ipc.isOnlyPlayer());
    }

    /**
     * Test method for {@link world.bentobox.chunkblock.commands.island.IslandPhasesCommand#execute(world.bentobox.bentobox.api.user.User, java.lang.String, java.util.List)}.
     */
    @Test
